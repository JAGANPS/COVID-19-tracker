...
class DataSource {
  static String quote =
      "Live in the present and shape the future,do not be casting lingering looks to the distant past for the past has passed away,never again to return.  #Stay Home #Stay Safe.";
